var imInit=function(area,imCandidates,imChooser,imInput,inputMethods){
	...
	for(var method in inputMethods){
		var desc=inputMethods[method];
		inputMethods[method]=createTableInputMethod(desc[0],desc[1],desc[2],desc[3]);
	}
